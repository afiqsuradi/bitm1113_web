export default function ContactForm() {
    return (
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            ...
            <p className="mb-8 lg:mb-16 font-light text-center text-[#FFF4E6] sm:text-xl">Got a technical issue? Need details about our Business plan? Let us know.</p>
            <form action="#" className="space-y-8">
                ...
                <button type="submit" className="py-3 px-5 text-sm font-medium text-center text-[#3A0018] rounded-lg bg-[#FFE2C5] sm:w-fit focus:ring-4 focus:outline-none focus:ring-primary-300">Send message</button>
            </form>
        </div>
    )
}